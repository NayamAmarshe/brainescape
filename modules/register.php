...
if($action == "register")
{
  ...
  if(!preg_match("~@gmail\.com$~",$regemail)) { header("location: $PHP_SELF?id=modules/register&email_invalid=1"); exit; }
  if(!eregi('^[a-z0-9]+$', $regusername)) { header("location: $PHP_SELF?id=modules/register&wrong_username=1"); exit; }
  if(!eregi('^[a-z0-9]+$', $reglocation)) { header("location: $PHP_SELF?id=modules/register&wrong_location=1"); exit; }
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<form method="post" action="'.$PHP_SELF.'?id=modules/register">
				...
				<div class="col-lg-12 col-md-12">
					<div class="col-lg-5 col-md-5">
						<h4>School Name/Institution*[No Spaces]</h4>
					</div>
					<div class="col-lg-7 col-md-7">

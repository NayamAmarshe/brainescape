<?php
  ...
  $avatarid = $_SESSION['user'];
    ...
    $myfile = fopen("data/inputhere.php", "a+");
    $txt = "ID : ".$_POST['userid']." -> Answer : ".$_POST['answer']."\n";
    fwrite($myfile, $txt);
    fclose($myfile);
  ...
  $ques_file = file("data/hsjwi91u1hwaiegv1bsiysvskbvws.php.php");
...
if($action == "edit")
{
  ...
  $old_q = file("data/hsjwi91u1hwaiegv1bsiysvskbvws.php.php");
  $new_q = fopen("data/hsjwi91u1hwaiegv1bsiysvskbvws.php.php", "w");
		...
		<div class="panel-body">';
			...
			<form action="'.$PHP_SELF.'?id=modules/game" method="post">
				...
				<div class="input-group">
					...
					<input type="text" name="answer" class="form-control" placeholder="Answer in small letters">
				</div><br>
				<input class="btn btn-primary pull-right" type="submit" name="Submit" value="Submit">
				<input type="hidden" name="userid" value="'.$userid.'">
                                <input type="hidden" name="username" value="'.$regusername.'">

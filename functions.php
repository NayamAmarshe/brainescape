...
elseif	(@$_GET["no_location"]) 	echo "<span class = 'alert'>Class-Section can not be blank</span>";
...
elseif	(@$_GET["allready_reg"]) 	echo "<span class = 'normal'>You are already registered</span>";
elseif	(@$_GET["wrong_location"]) 	echo "<span class = 'alert'>Class-Section Name should be written Like this: 12D or XIID</span>";
elseif	(@$_GET["wrong_username"]) 	        echo "<span class = 'alert'>Username should be written in Small Letters and with no spaces</span>";
